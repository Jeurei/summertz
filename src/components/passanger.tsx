...
const Passanger: React.FC<PassangerProps> = ({}) => {
        ...
        <FormComponent display="flex" flexDirection="column">
          ...
          >
            <Formfield
              ...
              required
            ></Formfield>
            <Formfield name="name" label="Имя" type="text" required></Formfield>
            <Formfield
              name="fathersName"
              ...
              labelTextOrNode={
                <>
                  ...
                  <p>
                    ...
                    символ «№» не указывается. Данные паспорта или свидетельства
                    о рождении, выданного гражданам иностранных государств,
                    вводятся с заданием типа документа - иностранный документ.
                  </p>
                </>
              }
              type="text"
